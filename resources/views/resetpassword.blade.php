				...
				<div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-20">
							...
							<!--end::Title-->
							<!--begin::Description-->
							<p class="d-none d-lg-block fw-semibold fs-2 text-white">Monitor Sungai Undip</p>
							<!--end::Description-->
						</div>
						<!--end::Header-->
						<!--begin::Illustration-->
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <div class="text-center mb-10">
                                ...
                                <!--end::Title-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-semibold fs-4">Enter your new password.</div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-solid" type="email" name="email" value="{{ $email ?? old('email') }}" autocomplete="off" />
                            </div>
                            <div class="fv-row mb-10">
